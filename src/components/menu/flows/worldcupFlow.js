  ...
  handlers: {
    ...
    faqPontuacao: async (ctx) => {
      await ctx.reply([
        ...
        "2️⃣ Se palpitar empate, será perguntado se quer palpitar a prorrogação (opcional, +1 pt)",
        "3️⃣ Em seguida, você escolhe quem avança nos pênaltis (opcional, +1 pt)",
        "",
        "🏅 *Pontuação:*",
        "• Placar exato nos 90min → *3 pts*",
        "• Resultado certo nos 90min → *1 pt*",
        "• ➕ Placar exato na prorrogação → *+2 pts*",
        "• ➕ Resultado certo na prorrogação → *+1 pt*",
        "• ➕ Vencedor certo nos pênaltis → *+1 pt*",
        "",
        "⚠️ Os bônus só valem se acertar o resultado dos 90min",
        "🥇 Máximo possível: *6 pts* por jogo",
        "",
