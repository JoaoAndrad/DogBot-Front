...
const COPY = {
  ...
  listas: [
    "🎬 *DogLog — Filmes, Livros e Listas*",
    "",
    "Seu diário de mídia pessoal. Registro o que você assistiu e leu, aceito avaliações e gero um card visual para compartilhar.",
    "",
    "*🎬 Filmes*",
    "Envie */filme* + nome. Te mostro título, sinopse, nota do TMDb e o que as pessoas do grupo acharam. Você pode marcar como assistido, dar uma nota de 0 a 5 ⭐ e adicionar à sua lista personalizada.",
    "",
    "*📖 Livros*",
    "Envie */livro* + nome, ISBN ou ID. Mesmo esquema — cartão com informações, avaliação e opção de salvar.",
    "",
    "*📋 Listas*",
    "Envie */listas* para gerenciar. Crio listas *privadas* (só você vê) ou *colaborativas* (todo o grupo acessa).",
    "",
    "*📊 Card de resumo*",
    "Gero uma imagem estilizada com tudo que você assistiu ou leu em um período escolhido para que você possa compartilhar.",
  ].join("\n"),
  ...
  fitness: [
    ...
    "",
    "*Ativar treinos*",
    "Em grupo, envie */ativartreinos*. Para ativar é necessário que um usuário VIP execute o comando.",
    "",
    "*Registrar treino*",
