...
const { cartolaFlow } = require("../../components/menu/flows/cartolaFlow");
const financialFlow = require("../../components/menu/flows/financialFlow");
...
flowManager.registerFlow(cartolaFlow);
flowManager.registerFlow(financialFlow);
